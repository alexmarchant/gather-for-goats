  ...
  render() {
    return (
      <div className="about">
        ...
        <h4>Collection</h4>
        <p>
          Pass this page around on a phone or tablet after the meal (just like you would a check!) to capitalize on the momentum and save guests from having to remember and dig up the page later.
        </p>
